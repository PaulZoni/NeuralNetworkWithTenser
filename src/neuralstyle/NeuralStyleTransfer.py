...
ap.add_argument("-m", "--model",
                ...
                default='/Users/pavel/PycharmProjects/NeuralNetworkWithTenser/src/neuralstyle/image/the_scream.t7')

ap.add_argument("-i", "--image",
                required=False,
                help="input image to apply neural style transfer to",
                default='/Users/pavel/PycharmProjects/NeuralNetworkWithTenser/src/neuralstyle/image/IMG_20190323_112221.jpg')
